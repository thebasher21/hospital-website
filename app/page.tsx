...
import { getTranslations, getTranslationValue } from '@/lib/server/translations';
...
export default async function Home() {
  ...
  const carouselSlides = getTranslationValue(translations, 'hero.carousel.slides') as CarouselSlide[] || [];
  ...
  const testimonials: Testimonial[] = [
    {
      quote: getTranslationValue(translations, 'testimonials.testimonial1.quote') as string || 
      ...
      name: getTranslationValue(translations, 'testimonials.testimonial1.name') as string || "John Doe",
      role: getTranslationValue(translations, 'testimonials.testimonial1.role') as string || "Cardiac Patient"
    },
    {
      quote: getTranslationValue(translations, 'testimonials.testimonial2.quote') as string || 
      ...
      name: getTranslationValue(translations, 'testimonials.testimonial2.name') as string || "Jane Smith",
      role: getTranslationValue(translations, 'testimonials.testimonial2.role') as string || "Maternity Patient"
    },
    {
  ...
  const galleryImageLabels = Array.from({ length: 5 }, (_, i) => {
    const label = getTranslationValue(translations, 'gallery.imageLabel');
    return typeof label === 'string' ? label.replace('{number}', (i + 1).toString()) : `Hospital Image ${i + 1}`;
  });
      ...
      <section className="bg-white dark:bg-gray-900/40 py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-slate-900 dark:text-white" data-i18n="services.title">
            {getTranslationValue(translations, 'services.title') as string || "Our Services"}
          </h2>
            ...
            <Card className="shadow-md border bg-white dark:bg-gray-800/60">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-lg sm:text-xl font-semibold text-slate-900 dark:text-white" data-i18n="services.emergency.title">
                  {getTranslationValue(translations, 'services.emergency.title') as string || "Emergency Care"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed" data-i18n="services.emergency.description">
                  {getTranslationValue(translations, 'services.emergency.description') as string || "24/7 emergency services with state-of-the-art facilities and expert medical staff."}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-md border bg-white dark:bg-gray-800/60">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-lg sm:text-xl font-semibold text-slate-900 dark:text-white" data-i18n="services.services.title">
                  {getTranslationValue(translations, 'services.specialized.title') as string || "Services"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed" data-i18n="services.services.description">
                  {getTranslationValue(translations, 'services.services.description') as string || "Comprehensive healthcare services including consultations, diagnostics, and various medical procedures."}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-md border bg-white dark:bg-gray-800/60">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-lg sm:text-xl font-semibold text-slate-900 dark:text-white" data-i18n="services.specialities.title">
                  {getTranslationValue(translations, 'services.specialities.title') as string || "Specialities"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed" data-i18n="services.specialities.description">
                  {getTranslationValue(translations, 'services.specialities.description') as string || "Specialized medical departments including Gynaecology & Obstetrics, Orthopedics, Pediatrics, and other critical medical specialties."}
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="bg-gray-100 dark:bg-gray-800/30 py-12 sm:py-16 md:py-20 border-y border-gray-200 dark:border-gray-700/30">
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-slate-900 dark:text-white" data-i18n="gallery.title">
            {getTranslationValue(translations, 'gallery.title') as string || "Gallery"}
          </h2>
          <GalleryCarousel imageLabels={galleryImageLabels} />
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-gray-900/40 py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-slate-900 dark:text-white" data-i18n="testimonials.title">
            {getTranslationValue(translations, 'testimonials.title') as string || "Patient Testimonials"}
          </h2>
