...
const taxExemptionDetails = {
    ...
    maxLimit:
        "No maximum limit for donation, but deduction limited to 10% of adjusted gross total income",
    documentRequired:
        "PAN Card details required for all donations above ₹2,000",
};
                ...
                <div className="p-6">
                    <div className="mb-8">
                        ...
                        <div className="space-y-3 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                            {Object.entries(accountDetails).map(
                                ([key, value]) => (
                                    <div
                                        key={key}
                    ...
                    <div className="mb-8">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                            <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
                                ...
                                {taxExemptionDetails.section}
                            </p>
                            <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
                                <span className="font-semibold">Benefit:</span>{" "}
                                {taxExemptionDetails.benefitPercentage}
                            </p>
                            <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
                                <span className="font-semibold">
                                    Eligibility:
                                </span>{" "}
                                {taxExemptionDetails.eligibility}
                            </p>
                            <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
                                <span className="font-semibold">
                                    Certificate:
                                </span>{" "}
                                {taxExemptionDetails.certificateIssue}
                            </p>
                            <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
                                <span className="font-semibold">
                                    Maximum Limit:
                                </span>{" "}
                                {taxExemptionDetails.maxLimit}
                            </p>
                            <p className="text-sm text-slate-600 dark:text-slate-300">
                                <span className="font-semibold">
                                    Documentation:
                                </span>{" "}
                                {taxExemptionDetails.documentRequired}
                            </p>
                        </div>
                    </div>
            ...
            <section className="bg-white dark:bg-gray-900/40 py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-lg text-slate-700 dark:text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
                        Your generous donations enable us to continue providing
                        high-quality healthcare services, acquire cutting-edge
                        medical equipment, and extend our reach to underserved
                        communities.
                    </p>
                    <Button
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        <Card className="border bg-white dark:bg-gray-800/70 shadow-sm">
                            ...
                            <CardContent>
                                <p className="text-sm text-slate-600 dark:text-slate-300 text-center">
                                    Help us acquire state-of-the-art medical
                                    equipment to enhance our diagnostic and
                        ...
                        <Card className="border bg-white dark:bg-gray-800/70 shadow-sm">
                            ...
                            <CardContent>
                                <p className="text-sm text-slate-600 dark:text-slate-300 text-center">
                                    Contribute to our fund that provides
                        ...
                        <Card className="border bg-white dark:bg-gray-800/70 shadow-sm">
                            ...
                            <CardContent>
                                <p className="text-sm text-slate-600 dark:text-slate-300 text-center">
                                    Support the expansion and improvement of our
                                    hospital facilities to better serve our
...
<<<<<<< HEAD
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-6xl mx-auto">
                        {donors.map((donor) => (
                            <Card
                                key={donor.id}
                                className="border bg-white dark:bg-gray-800/70 shadow-sm hover:shadow-md transition-shadow duration-300"
                            >
            ...
            <section className="bg-white dark:bg-gray-900/40 py-20">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-lg text-slate-700 dark:text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
                        We welcome corporate partnerships through CSR
                        initiatives. Partner with us to make a significant
                        impact on healthcare access and quality in our
                        community.
                    </p>
                    <Button
                        variant="outline"
                        className="font-medium border-blue-600 text-blue-600 hover:bg-blue-50 dark:border-blue-400 dark:text-blue-400 dark:hover:bg-blue-900/30"
                    >
